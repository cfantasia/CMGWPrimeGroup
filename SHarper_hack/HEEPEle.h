...
namespace heep {
  ...
  public:
    ...
    float isolPtTrksRel03() const{return gsfEle_->dr03TkSumPt()/gsfEle_->trackMomentumAtVtx().rho();}     //WP80
    float isolEmRel03()const{return gsfEle_->dr03EcalRecHitSumEt()/gsfEle_->trackMomentumAtVtx().rho();} //WP80
    float isolHadRel03()const{return gsfEle_->dr03HcalTowerSumEt()/gsfEle_->trackMomentumAtVtx().rho();} //WP80
