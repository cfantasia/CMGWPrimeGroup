...
//const string cuts_desc_short[Num_histo_sets] =
//{"hlt","ptrange","1mu","iso", "jet", "qual"};
const string cuts_desc_short[Num_histo_sets] = {"hlt","ptrange", "qual","1mu","iso", "jet"};
// use this for histogram descriptions
const string algo_desc_long[Num_trkAlgos] = {"global", "tracker", "TPFMS","cocktail","picky","TMR"};
//const string cuts_desc_long[Num_histo_sets]= {"HLT_Mu9", "Pt within
//range", "1 muon only","Isolation", "Jet Veto", "Quality"};
const string cuts_desc_long[Num_histo_sets]= {"HLT_Mu9", "Pt within range", "Quality", "1 muon only","Isolation", "Jet Veto"};
