...
const unsigned Nsignal_points = 9; // 1 bgd-only + 8 true-signal mass points
...
const string dirname[Nsignal_points] = {"wprime2.5", "wprime1.5", "wprime1.6", "wprime1.7", "wprime1.8", "wprime1.9", "wprime2.0", "wprime2.1", "wprime2.2"};


const string desc[Nsignal_points] = {"SM", "W' (1.5 TeV)", "W' (1.6 TeV)", 
			      "W' (1.7 TeV)", "W' (1.8 TeV)", "W' (1.9 TeV)",
			      "W' (2.0 TeV)", "W' (2.1 TeV)", "W' (2.2 TeV)"};

const float WprimeMass[Nsignal_points] = {2500, 1500, 1600, 1700, 1800, 1900, 2000, 
				   2100, 2200};
...
Color_t color[Nsignal_points] = {kBlack, kRed, kBlue, kViolet, kGreen, kOrange, kYellow, kViolet, kOrange};
