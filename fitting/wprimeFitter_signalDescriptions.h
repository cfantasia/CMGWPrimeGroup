...
const unsigned Nsignal_points = 2;//13; // 1 bgd-only + 12 true-signal mass points
...
const string dirname[Nsignal_points] = {"wprime2.5", "wprime1.0"};

//const string desc[Nsignal_points] = {"SM", "W' (1.0 TeV)", "W' (1.2 TeV)", "W' (1.3 TeV)", "W' (1.4 TeV)", "W' (1.5 TeV)", "W' (1.6 TeV)", "W' (1.7 TeV)", "W' (1.8 TeV)", "W' (1.9 TeV)", "W' (2.0 TeV)", "W' (2.1 TeV)", "W' (2.2 TeV)"};
const string desc[Nsignal_points] = {"SM", "W' (1.0 TeV)"};

//const float WprimeMass[Nsignal_points] = {2500, 1000, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100, 2200};
const float WprimeMass[Nsignal_points] = {2500, 1000};
...
//const float xsec_lep[Nsignal_points] = {0, 0.8856, 0.3461, 0.2221, 0.1440, 0.0949, 0.0633, 0.0424, 0.0285, 0.0194, 0.0135, 0.009373, 0.006605};
const float xsec_lep[Nsignal_points] = {0, 0.8856};
