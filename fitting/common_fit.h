...
// 0-->signal-free, 1-->0.6, 2-->0.7, 3-->0.8, 4-->0.9, 5-->1.0, 6-->1.1, 7-->1.2,
// 8--> 1.3, 9-->1.4, 10-->1.5, 11-->2.0 TeV
const unsigned mass_points = 12; 
const unsigned num_ref_plots = mass_points + 1; // equals to wprime points + bgd 

// used for filename storing fit results
string data_desc[mass_points] = {"NoSignal", "0.6TeV", "0.7TeV", "0.8TeV", 
				 "0.9TeV", "1.0TeV", "1.1TeV", "1.2TeV", 
				 "1.3TeV", "1.4TeV", "1.5TeV",
				 "2.0TeV"};

// used for description of the tree of the fit results
const string histo_desc[num_ref_plots] =
  {" Signal-free", " W ' (0.6 TeV)", " W ' (0.7 TeV)", " W ' (0.8 TeV)", 
   " W ' (0.9 TeV)"," W ' (1.0 TeV)", " W ' (1.1 TeV)", " W ' (1.2 TeV)", 
   " W ' (1.3 TeV)", " W ' (1.4 TeV)", " W ' (1.5 TeV)", 
