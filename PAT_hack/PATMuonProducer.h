...
namespace pat {
  ...
  private:
    ...
    /// input tag for default-tev muon refit
    edm::InputTag defaultTeVSrc_;
    /// input tag for DYT muon refit
    edm::InputTag dytSrc_;
    /// embed track from picky muon fit into the muon
    bool embedPickyMuon_;
    /// embed track from tpfms muon fit into the muon
    bool embedTpfmsMuon_;
    /// embed track from default-Tev muon fit into the muon
    bool embedDefaultTeVMuon_;
    /// embed track from DYT muon fit into the muon
    bool embedDytMuon_;
    /// embed track from cocktail muon fit into the muon
    bool embedCocktailMuon_;
