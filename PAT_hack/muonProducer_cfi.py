...
patMuons = cms.EDProducer("PATMuonProducer",
    ...
    defaultTeVSrc   = cms.InputTag("tevMuons", "default"),
    dytSrc          = cms.InputTag("tevMuons", "dyt"),
    ...
    embedDefaultTeVMuon = cms.bool(True),  ## embed in AOD externally stored TeV-refit default muon track
    embedDytMuon        = cms.bool(True),  ## embed in AOD externally stored TeV-refit DYT muon track
    embedCocktailMuon   = cms.bool(True),  ## embed in AOD externally stored TeV-refit cocktail muon track
