...
goldenJSONfile = 'UserCode/CMGWPrimeGroup/JSON/Cert_160404-178677_7TeV_PromptReco_Collisions11_JSON.txt'
MuonPhysJSONfile = 'UserCode/CMGWPrimeGroup/JSON/Cert_160404-178677_7TeV_PromptReco_Collisions11_JSON_MuonPhys.txt'
...
process.WprimeAnalyzer = cms.PSet(
    ...
    MCPUDistHist = cms.string('PoissonOneXDist'),
